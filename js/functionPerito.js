...
function cargarTratamientos( tratamientos){
    ...
    console.log("ENTRO EN TRATAMIENTOS nuevooo");
    console.log(tratamientos);

}

function abrirTratamientos(tratamientosArrayPHP){

    console.log("ENTRO EN TRATAMIENTOS nuevooo");
    console.log(tratamientosArrayPHP);
                                                ...
                                                <div class="card">
                                                    <div class="card-header" id="heading${i}">
                                                            ...
                                                            <div class="row">
                                                                    ...
                                                                    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#editarTratamientoModal" onclick="EditarTratamientos(${i})"><svg width="1.2em" height="1.2em" viewBox="0 0 16 16" class="bi bi-pencil-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
function EditarTratamientos(index){
    ...
    margin-bottom: 1em;
                ...
                <div class=" margintp col-8"> <input type="text" id="agri" value="${elemt.agricultor}"></input></div>
                </div>

                <div class="row">
                <div class=" marginltp col-3"><h4>Localizacion: </h4> </div>
                <div class=" margintp col-8"> <input type="text" id="localz" value="${elemt.localizacion}"></input></div>
                </div>

                <div class="row">
                <div class=" marginltp col-3"><h4>Fecha: </h4> </div>
                <div class=" margintp col-8"> <input type="text" id="fechM" value="${elemt.fecha}"></input></div>
                </div>
                
                <div class="row">
                <div class=" marginltp col-3"><h4>Tipo: </h4> </div>
                <div class=" margintp col-8"> <input type="text" id="tipo" value="${elemt.tipo}"></input></div>
                </div>

                <div class="row">
                <div class=" marginltp col-3"><h4>Compuesto: </h4> </div>
                <div class=" margintp col-8"> <input type="text" id="comp" value="${elemt.tipo}"></input></div>
                </div>
                <div class="row">
                <div class=" marginltp col-3"><h4>Estado: </h4> </div>
                <div class=" margintp col-8"> <input type="text" id="estado" value="${elemt.compuesto}"></input></div>
                </div>
                <div class="row">
                <div class=" marginltp col-3"><h4>Comentario </h4> </div>
                <div class=" margintp col-8"> <textarea type="text" id="comentario" value="${elemt.COMENTARIO}"></textarea></div>
                </div>
...
function ModificarT(index){
    var fech= document.getElementById("fechM").value;
    console.log(fech);
    console.log("antes del cambio");
    console.log(Tratamientos[index].fecha); 
    Tratamientos[index].fecha = fech;
