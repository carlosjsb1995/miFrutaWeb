...
function abrir(){
    ...
    <div class="col-3"> 
            <select class="browser-default custom-select">
            <option selected="true" value="Todos" >Todas las variedades</option>
...
console.log("ENTRO EN ALMACEN");
    ...
    <div class ="row marginz">
    <div class="col-3"> <button class="btn btn-primary " data-toggle="modal" data-target="#fm-modal" style="background: red;" onclick="AlmacenActual()"> ESTADO MI ALMACEN </button>
    </div>
    <div class="col-3"> 
    </div>
    <div class="col-3"> 
    ...
    <div class="col-3"> 
            <select class="browser-default custom-select">
            <option selected="true" value="Todos" >Todos los materiales</option>
            <option value="JoseSanchezCaja">Pale derma 3451</option>
            <option value="JoseSanchezCaja">Pale madera 422</option>
            <option value="JoseSanchezCaja">Caja derma 262</option>
            <option value="JoseSanchezCaja">Caja madera 264</option>
            <option value="JoseSanchezCaja">Plancha derma 127</option>
            <option value="JoseSanchezCaja">Plancha madera 128</option>
