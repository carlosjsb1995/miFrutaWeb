...
<body style="background: #f3f3f3;">
    ...
    <nav class=" marginz navbar navbar-expand-md navbar-dark bg-dark ">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="nav-content">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="#" onclick="abrir()">Entradas</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#" onclick="abrirAlmacen($user)">Almacen</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#" onclick="abrirTratamientos()">Tratamientos</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">Usuarios</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../inicio.html">Cerrar Sesion</a>
                </li>
            </ul>
    </nav>
    <br>
    ...
    <div class="modal fade" id="fm-modal" tabindex="-1" role="dialog" aria-labelledby="fm-modal" aria-hidden="true">
        <div class="modal-dialog">
            <div  id="ModalAlmacen" class="modal-content">
                
            </div>
        </div>
    </div>

    <div class="modal fade" id="editarEntradaModal" tabindex="-1" role="dialog" aria-labelledby="fm-modal" aria-hidden="true">
        <div class="modal-dialog">
            <div id="EditarEntrada" class="modal-content">
    
            </div>
        </div>
    </div>
    
    <div class="modal fade" id="añadirEntradaModal" tabindex="-1" role="dialog" aria-labelledby="fm-modal" aria-hidden="true">
        <div class="modal-dialog">
            <div  id="añadirEntrada" class="modal-content">
    ...
    <script src="../js/funcionUrlAdmin.js"></script>
